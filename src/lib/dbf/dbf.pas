...
//====================================================================
  ...
  TTranslateEvent = function(Dbf: TDbf; Src, Dest: {$IFDEF DELPHI_2009}PAnsiChar{$ELSE}PChar{$ENDIF}; ToOem: Boolean): Integer of object;
...
{$ifdef SUPPORT_NEW_TRANSLATE}
    function Translate(Src, Dest: {$IFDEF DELPHI_2009}PAnsiChar{$ELSE}PChar{$ENDIF}; ToOem: Boolean): Integer; override; {virtual}
{$else}
    procedure Translate(Src, Dest: {$IFDEF DELPHI_2009}PansiChar{$ELSE}PChar{$ENDIF}; ToOem: Boolean); override; {virtual}
{$endif}
...
var
  ...
  bufPos: {$IFDEF DELPHI_2009}PAnsiChar{$ELSE}PChar{$ENDIF};
  saveChar: AnsiChar;
begin
...
function TDbf.Translate(Src, Dest: {$IFDEF DELPHI_2009}PAnsiChar{$ELSE}PChar{$ENDIF}; ToOem: Boolean): Integer; {override virtual}
var
...
procedure TDbf.Translate(Src, Dest: {$IFDEF DELPHI_2009}PAnsiChar{$ELSE}PChar{$ENDIF}; ToOem: Boolean); {override virtual}
var
  FromCP, ToCP: Cardinal;
begin
  if (Src <> nil) and (Dest <> nil) then
